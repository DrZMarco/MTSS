...
public class UserTest {User user;
    ...
    public void initialize() {
        user = new User("Nicolo", "Trinca", "nicolo@gmail.com", LocalDate.of(2001,2,1));
    }
    ...
    public void testGetName() {
        assertEquals("Nicolo", user.getName());
    }
    ...
    public void testNullDateOfBirth() {
        try {
            new User("Nicolo", "Trinca", "nicolo@gmail.com", null);
    ...
    public void testFutureDateOfBirth() {
        try {
            new User("Nicolo", "Trinca", "nicolo@gmail.com", LocalDate.of(2051,2,1));
